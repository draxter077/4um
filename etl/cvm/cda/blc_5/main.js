export default async function main(text, sql) {
    ...
    for (let i = 1; i < totalLines; i++) {
        ...
        const row = [
            ...
            `'${infos[16]}'`, // CNPJ_EMISSOR
            `'${infos[17]}'`, // EMISSOR
            `'${infos[18]}'`, // DT_VENC
            `'${infos[19]}'`, // TITULO_POSFX
            `'${infos[20]}'`, // CD_INDEXADOR_POSFX
            `'${infos[21]}'`, // DS_INDEXADOR_POSFX
            infos[22] ? infos[22] : 'NULL', // PR_INDEXADOR_POSFX
            infos[23] ? infos[23] : 'NULL', // PR_CUPOM_POSFX
            infos[24] ? infos[24] : 'NULL', // PR_TAXA_PREFX
